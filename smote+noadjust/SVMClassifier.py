import random
from utils import min_max_data, read_file, read_smote_file, evaluate_a_p_r_f, evaluate_auc, evaluate_auc95ci
...
#数据处理
train_x, train_y, test_x, test_y = read_smote_file(train_path = "../smote_train.csv", test_path = "../smote_test.csv")
